...
prompt:	.asciiz "NumberA= "
prompt2: .asciiz "NumberB= "
...
DATA:    .word32 0x10008
		...
		daddi r30, r0, 0x400   ;; mimic runtime
		...
		lw r1, 4(r29) ; save second to stack, arg2
...
multime:
	...
	daddi r1,r0,prompt4  ; get address of "result= " string
    daddi r11,r0,4     ; set for string output  
	daddi r12,r0,1   ; set for integer output
	...
	daddi r2, r30, 36
	daddi r1,r0,prompt5  ; get address of "result= " string
	sd r1,(r8)       ; display "result"
	sd r11,(r9)
	sd r2,(r8)       ; output result
	sd r12,(r9)
